...
/**
 * Shows the specified visual layer (0-9).
 */
class ShowLayerBrick : FormulaBrick {
    ...
    override fun clone(): Brick {
        return ShowLayerBrick(getFormulaWithBrickField(Brick.BrickField.VALUE))
    }
}
