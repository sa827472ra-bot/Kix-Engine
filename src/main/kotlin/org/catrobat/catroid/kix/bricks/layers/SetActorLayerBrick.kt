/*
 * Kix Engine Mod - SetActorLayerBrick
...
/**
 * Assigns the current actor (sprite) to a specific visual layer (0-9).
 */
class SetActorLayerBrick : FormulaBrick {
    ...
    override fun clone(): Brick {
        return SetActorLayerBrick(getFormulaWithBrickField(Brick.BrickField.VALUE))
    }
}
