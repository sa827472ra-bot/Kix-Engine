/*
 * Kix Engine Mod - SendLayerToBackBrick
...
/**
 * Moves the specified layer to the back of the render order (index 0).
 */
class SendLayerToBackBrick : FormulaBrick {
    ...
    override fun clone(): Brick {
        return SendLayerToBackBrick(getFormulaWithBrickField(Brick.BrickField.VALUE))
    }
}
